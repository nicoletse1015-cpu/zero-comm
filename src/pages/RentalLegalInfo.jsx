...
import { 
  ChevronLeft, FileText, AlertTriangle, Clock, Building2, Scale, 
  ExternalLink, CheckCircle2, ArrowRight
} from 'lucide-react';

export default function RentalLegalInfo() {
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="sticky top-0 z-40 bg-white border-b">
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <h1 className="font-semibold">租賃法律須知</h1>
          <div className="w-9" />
        </div>
      </header>
              ...
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500 mb-3">可增刪條款，印刷 → 填寫 → 雙方親筆簽名即可</p>
